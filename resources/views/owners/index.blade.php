        ...
        <table id="example2" class="table table-bordered table-hover">
          ...
          <tr>
            ...
            <td class="project-actions text-center "> 
                ...
                <a class="btn btn-outline-info mr-2 btn-sm" href="{{route('owners.show',['owner'=>$owner->id])}}">
                    <i class="fas fa-folder"> </i> View 
                </a>
                <a class="btn btn-outline-warning mr-2 btn-sm" href="{{route('owners.edit',['owner'=>$owner->id])}}">
